      ...
      <main class="relative isolate flex min-h-dvh items-center justify-center overflow-hidden px-4 py-12 sm:px-6">
        ...
        <div class="w-full max-w-md">
          <header class="mb-8 text-center">
            <div
              class="mx-auto mb-4 grid size-11 place-items-center rounded-xl border border-accent/30 bg-accent/10 shadow-lg shadow-shadow/20"
              aria-hidden="true"
            >
          ...
          <Card class="shadow-2xl shadow-shadow/30" title="Welcome back">
